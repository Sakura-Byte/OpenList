...
func InitialSettings() []model.SettingItem {
	...
	"epub": {
		...
		{Key: conf.SignBindIP, Value: "false", Type: conf.TypeBool, Group: model.GLOBAL, Flag: model.PRIVATE, Help: "Bind client IP into download sign to prevent token reuse"},
		{
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.UpdateSiteEnabled, Value: "false", Type: conf.TypeBool, Group: model.GLOBAL, Flag: model.PRIVATE, Help: "Enable update-site webhook delivery"},
		{Key: conf.UpdateSiteInstanceName, Value: "main", Type: conf.TypeString, Group: model.GLOBAL, Flag: model.PRIVATE, Help: "Logical source name used in update-site webhook headers and payloads"},
		{Key: conf.UpdateSiteWebhookURL, Value: "", Type: conf.TypeString, Group: model.GLOBAL, Flag: model.PRIVATE, Help: "Target update-site webhook URL"},
		{Key: conf.UpdateSiteWebhookSecret, Value: "", Type: conf.TypeString, Group: model.GLOBAL, Flag: model.PRIVATE, Help: "Shared secret used to sign update-site webhook payloads"},
		...
		{Key: conf.EnableListRForIndexScan, Value: "false", Type: conf.TypeBool, Group: model.INDEX, Flag: model.PRIVATE, Help: `enable backend ListR for index build/update/manual scan`},
		...
		{Key: conf.GuestDownloadConcurrency, Value: "3", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE, Help: "Concurrent downloads for guest user (0 means unlimited)"},
		...
		{Key: conf.IPDownloadConcurrency, Value: "3", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE, Help: "Concurrent downloads per IP for guest users (0 means unlimited)"},
